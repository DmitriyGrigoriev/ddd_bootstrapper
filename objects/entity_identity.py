...
class EntityIdentity(DddObject):
    arg_short_name = "ei"
    arg_long_name = "entity_identity"
    help_text = "Specify the name of the identity of the aggregate (in CamelCase)"
...
class {self.name}(interface.Entity):
    pass
"""
